# Claude Multi-Agent Console &nbsp;·&nbsp; v0.1.5
...
[로컬 Windows]                                  [원격 Linux 서버]
  ClaudeMultiAgentConsole-0.1.5.exe             ~/Claude_Multi_Agent_Console/
...
1. [Releases](https://github.com/hanoong7/Claude_Multi_Agent_Console/releases) 가서 `ClaudeMultiAgentConsole-0.1.5.exe` 다운로드
...
```
C:\Apps\AgentConsole\
├── ClaudeMultiAgentConsole-0.1.5.exe
└── config.json
```
...
npm install
npm run dist:win    # → dist-installers/ClaudeMultiAgentConsole-0.1.5.exe
```
